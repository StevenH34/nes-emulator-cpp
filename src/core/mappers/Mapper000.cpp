...
std::uint8_t Mapper000::ReadPrg(const std::uint16_t address) const { return prg_rom_[address & prg_mask_]; }

std::uint8_t Mapper000::ReadChr(const std::uint16_t address) const { return chr_rom_[address & CHR_MASK]; }
